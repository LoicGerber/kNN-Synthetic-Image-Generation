...
normMethods       = [1,1,1,4];                      % Method of normalisation of the climate data. 0 = No normalisation, 1 = MinMax, 2 = Q5-Q95, 3 = log(x(x>0)+1), 4 = mean dist Hamming & log(x(x>0)+1)
...
metricKNN         = 2;          % 1 = RMSE, 2 = MAE, 3 = Manhattan distance, 4 = Euclidean distance, 5 = SPEM, 6 = 0.5*SPEM + 0.5*Hellinger
