...
optimPrep         = 0;    % 0 = optimisation preparation ON, 1 = optimisation preparation OFF (!!! BYPASSES PREVIOUS SWITCHES !!!)
...
if optimisation == 0
    ...
    results = bayesopt(fun,[Et_W,Tavg_ShortW,Tmin_ShortW,Tmax_ShortW,Pre_ShortW,Tavg_LongW,Tmin_LongW,Tmax_LongW,Pre_LongW],'Verbose',1,'AcquisitionFunctionName','expected-improvement-plus','MaxObjectiveEvaluations',5);
