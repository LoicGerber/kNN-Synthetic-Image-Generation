function sortedDates = KNNDataSorting(var,vars,addVars,queryDates,learningDates,climateData,additionalVars,shortWindow,longWindow,Weights,nbImages,optimisation,inputDir)
...
%for i = 1:totQDates
    ...
    doyQ = day(datetime(currentQDate,'ConvertFrom','yyyyMMdd'),'dayofyear');
    minRangeQ = doyQ - 90;
